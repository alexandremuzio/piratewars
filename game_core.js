...
function Player (uuid) {
    this.phaser = null;
    this.radius = 10; // Change the circle radius to detect collision
...
World.prototype.addPlayer = function(uuid) {
...
// Given the player inputs, the physics logic should run here
World.prototype.updatePlayer = function(uuid, keyboard) {
	if (keyboard.isDown(Phaser.Keyboard.LEFT) ||
        keyboard.isDown(Phaser.Keyboard.A))
    {
        //  Move to the left
        this.players[uuid].body.velocity[0] -= 10;
    }
    ...
    {
        //  Move up
        this.players[uuid].body.velocity[1] -= 10;
    }
...
World.prototype.updatePhaser = function() {
